...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        self.canvas_widget = tk.Canvas(self,  bg='gray',
        ...
        self.obstacle1 = self.canvas_widget.create_image(0, pixels, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(pixels, pixels,  anchor='nw', image=self.obstacle2_object)
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(pixels * 2, pixels, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 3, pixels,  anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 4, pixels,  anchor='nw', image=self.obstacle2_object)
        # Obstacle 6
        ...
        self.flag = self.canvas_widget.create_image(0, 0, anchor='nw', image=self.flag_object)
